...
async def lifespan(app: FastAPI):
    ...
    # Stage 6 audit hooks (see docs/CODE_SAFETY_PIPELINE.md). Wrapped in
    # try/except so a misbehaving hook never breaks startup -- this is
    # observability, not a hard requirement.
    if AUDIT_HOOKS_ENABLED.value:
        try:
            from open_webui.utils.audit_hooks import install_audit_hook

            install_audit_hook(
                CODE_INTERPRETER_BLOCKED_MODULES,
                block_blocked_imports=bool(AUDIT_HOOKS_BLOCK_BLOCKED_IMPORTS.value),
            )
        except Exception as e:
            log.warning('Failed to install audit hook: %s', e)
...
app.state.config.TOOL_USE_CAPABLE_MODELS = TOOL_USE_CAPABLE_MODELS
app.state.config.TOOL_USE_CAPABLE_MODELS_DENYLIST = TOOL_USE_CAPABLE_MODELS_DENYLIST
...
app.state.config.WEB_SEARCH_MAX_DEEPENS = WEB_SEARCH_MAX_DEEPENS
app.state.config.WEB_HEADING_TRIM_ENABLED = WEB_HEADING_TRIM_ENABLED
app.state.config.WEB_HEADING_TRIM_MIN_TOKEN_LEN = WEB_HEADING_TRIM_MIN_TOKEN_LEN
app.state.config.WEB_HEADING_TRIM_KEEP_INTRO = WEB_HEADING_TRIM_KEEP_INTRO
app.state.config.WEB_JS_FALLBACK_ENABLED = WEB_JS_FALLBACK_ENABLED
app.state.config.WEB_JS_FALLBACK_MIN_EXTRACT_CHARS = WEB_JS_FALLBACK_MIN_EXTRACT_CHARS
app.state.config.WEB_SEARCH_COMPRESS_ENABLED = WEB_SEARCH_COMPRESS_ENABLED
app.state.config.WEB_SEARCH_COMPRESS_MODEL = WEB_SEARCH_COMPRESS_MODEL
app.state.config.WEB_SEARCH_COMPRESS_BASE_URL = WEB_SEARCH_COMPRESS_BASE_URL
app.state.config.WEB_SEARCH_COMPRESS_CONCURRENCY = WEB_SEARCH_COMPRESS_CONCURRENCY
app.state.config.WEB_SEARCH_COMPRESS_TIMEOUT_SECONDS = WEB_SEARCH_COMPRESS_TIMEOUT_SECONDS
app.state.config.KB_CODE_AST_SPLIT_ENABLED = KB_CODE_AST_SPLIT_ENABLED
...
app.state.config.ENABLE_KAGI_LENS_ROUTING = ENABLE_KAGI_LENS_ROUTING
app.state.config.KAGI_LENSES_CONFIG_PATH = KAGI_LENSES_CONFIG_PATH
app.state.config.ENABLE_ARXIV_SEARCH = ENABLE_ARXIV_SEARCH
app.state.config.ENABLE_DOCS_ROUTING = ENABLE_DOCS_ROUTING
app.state.config.ENABLE_MDN_SEARCH = ENABLE_MDN_SEARCH
app.state.config.ENABLE_MSLEARN_SEARCH = ENABLE_MSLEARN_SEARCH
app.state.config.ENABLE_GODOT_SEARCH = ENABLE_GODOT_SEARCH
app.state.config.ENABLE_HF_SEARCH = ENABLE_HF_SEARCH
app.state.config.ENABLE_BITBUCKET_SEARCH = ENABLE_BITBUCKET_SEARCH
app.state.config.BITBUCKET_ACCESS_TOKEN = BITBUCKET_ACCESS_TOKEN
app.state.config.BITBUCKET_WORKSPACE = BITBUCKET_WORKSPACE
app.state.config.WEB_SEARCH_FANOUT_KAGI = WEB_SEARCH_FANOUT_KAGI
...
app.state.config.ENABLE_AUTO_MEMORY_EXTRACTION = ENABLE_AUTO_MEMORY_EXTRACTION
app.state.config.AUTO_MEMORY_EXTRACTION_PROMPT_TEMPLATE = AUTO_MEMORY_EXTRACTION_PROMPT_TEMPLATE
app.state.config.AUTO_MEMORY_EXTRACTION_DEDUP_THRESHOLD = AUTO_MEMORY_EXTRACTION_DEDUP_THRESHOLD
app.state.config.AUTO_MEMORY_EXTRACTION_MIN_USER_CHARS = AUTO_MEMORY_EXTRACTION_MIN_USER_CHARS
